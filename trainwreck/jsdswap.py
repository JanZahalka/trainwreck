...
class JSDSwap(DataPoisoningAttack):
    """
    Swaps images among classes based on the Jensen-Shannon distance between classes. Each class swaps images
    with the MAXIMALLY distant class to maximize distribution distortion.
    """
        ...
        while len(clean_classes) > 0:
            ...
            for c in [attacked_class, furthest_class]:
                try:
                    ...
                    # This means we're trying to take more samples than there are in the swap candidate
                    # set. This means we take the whole set
